...
class HewalexMQTT:
    ...
    def _subscribe_command(self, topic, key, entity_type):
    ...
    def _handle_command(self, key, entity_type, payload):
    ...
    def publish_status(self, parsed_status):
    ...
    def publish_config(self, parsed_config):
        if not self.connected:
            return
    ...
    def publish_raw_registers(self, reg_type, base, values):
